 ...
 * Membership.
 *
 * Una misma StructureConstituentRelationDefinition puede participar en múltiples
 * materializaciones explícitas e independientes de ParticipantsPresence.
 *
 * Esta fase NO introduce unicidad, canonicalidad, equivalencia,
 * conflicto, deduplicación, vigencia, preferencia ni selección
 * entre declaraciones explícitas de participantes.
 *
 * CriterionContentConstitutionElementPresence permanece en una
 * rama independiente y NO se convierte automáticamente en
 * StructureConstituentPresence, StructureConstituentRelationPresence
 * ni StructureConstituentRelationParticipantsPresence.
 *
...
export type  =
  {
...
export type  =
  {
    ...
    participationSemanticStructureParticipantRoleCompatibilityCriterionContentStructureConstituentRelationParticipantsInput:
      ;
...
export function (
  :
    ,
  ...
  | null {
  const  =
    
  ...
  const  =
  ...
  const genealogicalConstituentId =
    
      .participationSemanticStructureParticipantRoleCompatibilityCriterionContentStructureConstituentPresenceInput
      .participationSemanticStructureParticipantRoleCompatibilityCriterionContentStructureConstituentId;

  const  =
    
  ...
  const  =
    
  ...
  const  =
    
